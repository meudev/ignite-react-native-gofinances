...
import { TransctionCard, TransctionCardProps } from '../../components/TransactionCard';
...
export interface DataListProps extends TransctionCardProps {
    id: string;
}
...
export function Dashboard() {
    ...
    async function loadTransactions() {
        ...
        const transctionsFormatted: DataListProps[] = transactions.map((item: DataListProps) => {
